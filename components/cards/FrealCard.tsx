...
import DeleteFreal from "../forms/DeleteFreal";
...
function FrealCard({ id, currentUserId, parentId, content, author, community, createdAt, comments, isComment }: Props) {
  return (
